    ...
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper d-flex align-items-center auth"
                style="background-image:url({{ asset('bg.jpg') }});background-repeat:no-repeat;background-size:100%">
                <div class="row w-100 " style="opacity: .85">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            {{-- <div class="brand-logo">
                                <img src="https://www.bootstrapdash.com/demo/victory/template/images/logo.svg"
                                    alt="logo">
                            </div> --}}
                            ...
                            <form class="pt-3" method="POST" action="{{ url('/login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg border-info" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-lg border-info"
