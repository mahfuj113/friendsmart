                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <small><strong>Delevery Date (Approx) : </strong><br>{{$order->updated_at}}</small>
                                        </div>
                                    </div>
                                    <hr>
                                    @endforeach
                            ...
                            <a onclick="return confirm('Are you sure want to confirm ?')" href="{{route('update_order',['On the way',$order->id])}}" class="text-white mr-1 btn btn-sm btn-outline-danger" style="font-size:12px;text-decoration:none">On the way</a>
