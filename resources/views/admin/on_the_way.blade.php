                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure want to confirm ?')" href="{{route('update_order2',['Delevered',$order->id])}}" class="text-white mr-1 btn btn-sm btn-outline-danger" style="font-size:12px;text-decoration:none">Delevered</a>
