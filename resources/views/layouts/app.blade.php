...
<body class="sidebar-fixed sidebar-dark">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-dark">
            <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                ...
                <a class="navbar-brand brand-logo" href="{{ url('/home') }}"><img
                        src="@if($logo!=NULL){{ asset($logo->logo) }}@endif" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/home') }}">@if($logo!=NULL)<img
                        src="{{ asset($logo->logo) }}" alt="logo" />@endif</a>
            </div>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('category') }}">Category</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('sub_category') }}">Sub-category</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('add_product') }}">Add
                                        Product</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('view_product') }}">View
                                        Product</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('processing_orders') }}">Processing</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('on_the_way_orders') }}">On the
                                        way</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('delevered_orders') }}">Delevered</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui3">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('pending_exchange') }}">Pending</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('accepted_exchange') }}">Accepted</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('completed_exchange') }}">Completed</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui4">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('admin_logo') }}">Admin
                                        Logo</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('accepted_exchange') }}">Main
                                        Logo</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <footer class="footer">
                    <div class="container-fluid clearfix">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © @php
                            ...
                            echo($formatedDate); @endphp<a href="#"> <i class="fa fa-free-code-camp text-danger"></i>
                                Friends Mart</a>. All rights reserved.</span>
    ...
    <script src="{{asset('admin/js/avgrund.js')}}"></script>
